namespace DrawXXL
{
    ...
    public class BezierSplineDrawerInspector : VisualizerParentInspector
    {
        ...
        {
            Start_handlesChangeCheck();
            var fmh_812_318_639054848875907571 = Quaternion.identity; Vector3 pos_shiftedByFreeMoveHandle_inUnitsOfGlobalSpace = Handles.FreeMoveHandle(bezierSplineDrawer_unserializedMonoB.listOfControlPointTriplets[i].anchorPoint.controlID_ofCustomHandles_sphere, bezierSplineDrawer_unserializedMonoB.listOfControlPointTriplets[i].anchorPoint.GetPos_inUnitsOfGlobalSpace(), size_ofAnchorPointsCustomHandle, Vector3.one, Handles.SphereHandleCap);
        ...
        {
            Start_handlesChangeCheck();
            var fmh_1183_188_639054848875935393 = Quaternion.identity; Vector3 posOfSphereHandle_afterDrag_shifedInsideCamPlane_inUnitsOfGlobalSpace = Handles.FreeMoveHandle(controlID_ofHandle, concernedHelperPoint.GetPos_inUnitsOfGlobalSpace(), handleSize, Vector3.one, Handles.SphereHandleCap);
            bool hasChanged = End_handlesChangeCheck("Position of Bezier Point", i, true);
